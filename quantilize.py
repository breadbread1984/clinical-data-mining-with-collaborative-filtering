...
def read(filename):
  ...
  for rx in range(1, sh.nrows):
    ...
    if sex not in labels_collection['Sex']: labels_collection['Sex'][sex.value] = len(labels_collection['Sex']);
    if pslabel not in labels_collection['Primary Site - labeled']: labels_collection['Primary Site - labeled'][pslabel.value] = len(labels_collection['Primary Site - labeled']);
    if grade not in labels_collection['Grade']: labels_collection['Grade'][grade.value] = len(labels_collection['Grade']);
    if laterality not in labels_collection['Laterality']: labels_collection['Laterality'][laterality.value] = len(labels_collection['Laterality']);
    if ss not in labels_collection['Summary stage 2000 (1998+)']: labels_collection['Summary stage 2000 (1998+)'][ss.value] = len(labels_collection['Summary stage 2000 (1998+)']);
    if dasg7 not in labels_collection['Derived AJCC Stage Group, 7th ed (2010-2015)']: labels_collection['Derived AJCC Stage Group, 7th ed (2010-2015)'][dasg7.value] = len(labels_collection['Derived AJCC Stage Group, 7th ed (2010-2015)']);
    if dat7 not in labels_collection['Derived AJCC T, 7th ed (2010-2015)']: labels_collection['Derived AJCC T, 7th ed (2010-2015)'][dat7.value] = len(labels_collection['Derived AJCC T, 7th ed (2010-2015)']);
    if dan7 not in labels_collection['Derived AJCC N, 7th ed (2010-2015)']: labels_collection['Derived AJCC N, 7th ed (2010-2015)'][dan7.value] = len(labels_collection['Derived AJCC N, 7th ed (2010-2015)']);
    if dam7 not in labels_collection['Derived AJCC M, 7th ed (2010-2015)']: labels_collection['Derived AJCC M, 7th ed (2010-2015)'][dam7.value] = len(labels_collection['Derived AJCC M, 7th ed (2010-2015)']);
    if dasg6 not in labels_collection['Derived AJCC Stage Group, 6th ed (2004-2015)']: labels_collection['Derived AJCC Stage Group, 6th ed (2004-2015)'][dasg6.value] = len(labels_collection['Derived AJCC Stage Group, 6th ed (2004-2015)']);
    if dat6 not in labels_collection['Derived AJCC T, 6th ed (2004-2015)']: labels_collection['Derived AJCC T, 6th ed (2004-2015)'][dat6.value] = len(labels_collection['Derived AJCC T, 6th ed (2004-2015)']);
    if dan6 not in labels_collection['Derived AJCC N, 6th ed (2004-2015)']: labels_collection['Derived AJCC N, 6th ed (2004-2015)'][dan6.value] = len(labels_collection['Derived AJCC N, 6th ed (2004-2015)']);
    if dam6 not in labels_collection['Derived AJCC M, 6th ed (2004-2015)']: labels_collection['Derived AJCC M, 6th ed (2004-2015)'][dam6.value] = len(labels_collection['Derived AJCC M, 6th ed (2004-2015)']);
    if as3e not in labels_collection['AJCC stage 3rd edition (1988-2003)']: labels_collection['AJCC stage 3rd edition (1988-2003)'][as3e.value] = len(labels_collection['AJCC stage 3rd edition (1988-2003)']);
    if tvba3 not in labels_collection['T value - based on AJCC 3rd (1988-2003)']: labels_collection['T value - based on AJCC 3rd (1988-2003)'][tvba3.value] = len(labels_collection['T value - based on AJCC 3rd (1988-2003)']);
    if nvba3 not in labels_collection['N value - based on AJCC 3rd (1988-2003)']: labels_collection['N value - based on AJCC 3rd (1988-2003)'][nvba3.value] = len(labels_collection['N value - based on AJCC 3rd (1988-2003)']);
    if mvba3 not in labels_collection['M value - based on AJCC 3rd (1988-2003)']: labels_collection['M value - based on AJCC 3rd (1988-2003)'][mvba3.value] = len(labels_collection['M value - based on AJCC 3rd (1988-2003)']);
    if rsws not in labels_collection['Radiation sequence with surgery']: labels_collection['Radiation sequence with surgery'][rsws.value] = len(labels_collection['Radiation sequence with surgery']);
    if rncds not in labels_collection['Reason no cancer-directed surgery']: labels_collection['Reason no cancer-directed surgery'][rncds.value] = len(labels_collection['Reason no cancer-directed surgery']);
    if rr not in labels_collection['Radiation recode']: labels_collection['Radiation recode'][rr.value] = len(labels_collection['Radiation recode']);
    if cr not in labels_collection['Chemotherapy recode (yes, no/unk)']: labels_collection['Chemotherapy recode (yes, no/unk)'][cr.value] = len(labels_collection['Chemotherapy recode (yes, no/unk)']);
    if scmd1 not in labels_collection['SEER Combined Mets at DX-bone (2010+)']: labels_collection['SEER Combined Mets at DX-bone (2010+)'][scmd1.value] = len(labels_collection['SEER Combined Mets at DX-bone (2010+)']);
    if scmd2 not in labels_collection['SEER Combined Mets at DX-brain (2010+)']: labels_collection['SEER Combined Mets at DX-brain (2010+)'][scmd2.value] = len(labels_collection['SEER Combined Mets at DX-brain (2010+)']);
    if scmd3 not in labels_collection['SEER Combined Mets at DX-liver (2010+)']: labels_collection['SEER Combined Mets at DX-liver (2010+)'][scmd3.value] = len(labels_collection['SEER Combined Mets at DX-liver (2010+)']);
    if scmd4 not in labels_collection['SEER Combined Mets at DX-lung (2010+)']: labels_collection['SEER Combined Mets at DX-lung (2010+)'][scmd4.value] = len(labels_collection['SEER Combined Mets at DX-lung (2010+)']);
    if csr not in labels_collection['COD to site recode']: labels_collection['COD to site recode'][csr.value] = len(labels_collection['COD to site recode']);
    if scsdc not in labels_collection['SEER cause-specific death classification']: labels_collection['SEER cause-specific death classification'][scsdc.value] = len(labels_collection['SEER cause-specific death classification']);
    if socdc not in labels_collection['SEER other cause of death classification']: labels_collection['SEER other cause of death classification'][socdc.value] = len(labels_collection['SEER other cause of death classification']);
    if vsr not in labels_collection['Vital status recode (study cutoff used)']: labels_collection['Vital status recode (study cutoff used)'][vsr.value] = len(labels_collection['Vital status recode (study cutoff used)']);
    if ror not in labels_collection['Race and origin recode (NHW, NHB, NHAIAN, NHAPI, Hispanic)']: labels_collection['Race and origin recode (NHW, NHB, NHAIAN, NHAPI, Hispanic)'][ror.value] = len(labels_collection['Race and origin recode (NHW, NHB, NHAIAN, NHAPI, Hispanic)']);
    if ir not in labels_collection['Insurance Recode (2007+)']: labels_collection['Insurance Recode (2007+)'][ir.value] = len(labels_collection['Insurance Recode (2007+)']);
    if msad not in labels_collection['Marital status at diagnosis']: labels_collection['Marital status at diagnosis'][msad.value] = len(labels_collection['Marital status at diagnosis']);
